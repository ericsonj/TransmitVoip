...
volatile int power2[15] = { 1, 2, 4, 8, 0x10, 0x20, 0x40, 0x80, 0x100, 0x200,
 ...
 *
 */
int predictor_zero(g726_state *restrict state_ptr) {
	int i;
	int sezi;
...
g726_state *restrict state_ptr) /* coder state pointer */
{
	int cnt;
